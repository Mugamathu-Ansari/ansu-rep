...
function wp_shop_woocommerce_customize_register( $wp_customize ) {
    ...
    */
	...
	$wp_customize->add_setting(
		'wp_shop_woocommerce_enable_pagination',
		array(
			'capability'        => 'edit_theme_options',
			'transport'         => 'refresh',
			'default'           => 1,
	...
	$wp_customize->add_control(
		'wp_shop_woocommerce_enable_pagination',
		array(
			'label'       => __('Enable Pagination', 'wp-shop-woocommerce'),
			'description' => __('Checked to show Pagination', 'wp-shop-woocommerce'),
			'section'     => 'wp_shop_woocommerce_additional_section',
			'type'        => 'checkbox',
		)
	);
	...
	$wp_customize->add_setting('wp_shop_woocommerce_pagination_type',array(
        'default' => 'type-1',
        'sanitize_callback' => 'wp_shop_woocommerce_sanitize_choices'
	));
	$wp_customize->add_control('wp_shop_woocommerce_pagination_type',array(
        'type' => 'select',
        'label' => esc_html__('Select Pagination Type','wp-shop-woocommerce'),
        'section' => 'wp_shop_woocommerce_additional_section',
        'choices' => array(
            'type-1' => esc_html__('Type 1','wp-shop-woocommerce'),
            'type-2' => esc_html__('Type 2','wp-shop-woocommerce'),
        ),
	) );
