			...
			<div class="container">
				...
				<div class="site-info">
	                ...
	                <?php
	                    ...
	                    <a href="<?php echo esc_url('https://www.revolutionwp.com/products/storefront-woocommerce'); ?>" target="_blank">
	                      <?php esc_html_e('The Storefront Woocommerce Theme By Revolution WP ','the-storefront-woocommerce'); ?>
	                    </a>
	                    <?php } else {
